...
public class BlockWeDo extends BlockContainer implements IPeripheralProvider {
	...
	/**
	 * Later, the WeDo block can be controlled to emit redstone.
    ...
    // End of redstone preparation stuff
    
    
    /**
     * If the Block is a TESR, we must disable some things...
     * Maybe removed.
     */
