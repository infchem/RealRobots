...
public class ContainerLeonardo extends Container {

	private TileEntityLeonardo tileEntity;
	private InventoryPlayer inventoryPlayer;

    public ContainerLeonardo (InventoryPlayer _inventoryPlayer, TileEntityLeonardo te){
            this.tileEntity = te;
